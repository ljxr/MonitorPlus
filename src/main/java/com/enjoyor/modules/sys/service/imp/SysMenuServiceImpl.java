...
public class SysMenuServiceImpl implements SysMenuService {
	...
	@Override
	public void deleteBatch2(Long[] menuIds) {
		// TODO Auto-generated method stub
		sysMenuDao.deleteBatch2(menuIds);
	}
	
	@Override
	public List<String> getMenuPerms(String userName) {
		return sysMenuDao.getMenuPerms(userName);
	}
}
