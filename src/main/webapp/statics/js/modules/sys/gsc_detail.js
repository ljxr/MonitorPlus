...
function search_Alarm(){
	...
	$.ajax({
	    ...
	    success: function(r){
	    	...
	    	console.log(vm.alarm.siteId.length);
	    	if(vm.alarm.siteId.length){
	    		vm.alarm.siteId = vm.alarm.siteId.substr(0,vm.alarm.siteId.length-1);
	    	}
	    	console.log(vm.alarm.siteId);
